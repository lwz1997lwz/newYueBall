...
public class MyoriginId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MyoriginId) ) return false;
		 MyoriginId castOther = ( MyoriginId ) other; 
         
		 return ( (this.getMylogname()==castOther.getMylogname()) || ( this.getMylogname()!=null && castOther.getMylogname()!=null && this.getMylogname().equals(castOther.getMylogname()) ) )
 && ( (this.getMatchId()==castOther.getMatchId()) || ( this.getMatchId()!=null && castOther.getMatchId()!=null && this.getMatchId().equals(castOther.getMatchId()) ) );
   }
